...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`bg-dark dark:bg-light block transition-all duration ease-out h-0.5 w-6 rounded-sm  ${
            isOpen ? 'rotate-45 translate-y-1' : ' -translate-y-0.5'
          }`}
        ></span>
        <span
          className={`bg-dark dark:bg-light block transition-all duration ease-out h-0.5 w-6 rounded-sm my-0.5 ${
    ...
    -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'
        >
          <nav className='flex items-center flex-col justify-cente flex-wrap'>
            <CustomMobileLink
              href='/'
              title='Home'
              className=''
